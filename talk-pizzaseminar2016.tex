...
\author[Pizzaseminar in Mathematik]{Ingo Blechschmidt \\[0.1em] \tiny \texttt{iblech@speicherleck.de}}
\institute{Pizzaseminar in Mathematik \\ Universität Augsburg}
...
% http://www.presse.uni-augsburg.de/bilder/fotos_downl_pr/archiv1/Eschenburg-Tafel.jpg
\begin{frame}[plain,c]
...
\begin{frame}\frametitle{Weitere Beispiele}
  ...
  \begin{enumerate}
    ...
    \item $\phantom{0}\sqrt{3} = [1; 1, 2, 1, 2, 1, 2, 1, 2, \ldots]$
    ...
    $\phantom{\sqrt{10}} = 2{,}718\,281\,8284\,590\,452\,3536\ldots$
  \end{enumerate}

  \hfill
  \includegraphics[width=0.4\textwidth]{e-kaertchen}
  \par
\end{frame}
...
\note{\justifying
  ...
  Wir vom \href{http://www.curry-club-augsburg.de}{Curry Club Augsburg} werden
  in den nächsten Wochen im OpenLab einen kostenlosen Haskell-Workshop
  veranstalten.\par

  \centering
  \includegraphics[width=0.5\textwidth]{curry-club}
  \par
}
...
\note{\justifying
  ...
  Mit dem freien Programm XaoS kann man interaktiv das Mandelbrot-Fraktal (und
  weitere Fraktale) erkunden.\par
}
...
\begin{frame}\frametitle{Bildquellen}
  ...
  \mbox{\url{http://www.presse.uni-augsburg.de/bilder/fotos_downl_pr/archiv1/Eschenburg-Tafel.jpg}}
  \mbox{\url{http://www.presse.uni-augsburg.de/bilder/fotos_downl_pr/archiv1/Eschenburg-Zapfen-64745753348_thumb.jpg}}
