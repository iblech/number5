...
\begin{center}\includegraphics[width=0.68\textwidth]{hafez-tomb}\end{center}
...
\begin{center}\includegraphics[width=0.42\textwidth]{sonnenblume}\end{center}
...
Sei weiterhin~$M$ nicht total geodätische Minimalfläche in~$S^3(1)$. Was ist
eine untere Schranke für~$\mathrm{ind}(M)$ und für welche Minimalflächen wird diese
angenommen?
\end{aufgabe}

\vfill
\begin{center}\includegraphics[width=0.83\textwidth]{goldene-spirale-8}\end{center}

\end{document}

Weitere Ideen:
* 1/89 = Summe der f_n/10^(n+1).
