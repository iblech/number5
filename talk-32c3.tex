...
\begin{frame}\frametitle{(Not) using the golden ratio}
  \centering
...
\note{\justifying
  The middle figure uses the golden angle. The angle used in the four
  figures in the bottom:
  \begin{enumerate}
...
\note{\justifying
  ...
  \centering
  \includegraphics[scale=0.1]{vi-hart}
  \bigskip
